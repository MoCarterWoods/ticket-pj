    ...
    <tbody>
        <tr style="border-bottom: 1px solid #000">
            <td class="auto-style4">
                <img id="ContentPlaceHolder1_Image1" src="Img/Logo.png" style="height:37px;width:174px;">
            </td>
            <td colspan="7" style="text-align: center; font-size: 20px; font-weight: 800" class="auto-style4">ใบเสนอแนะการปรับปรุงแก้ไข (Kaizen sheet &amp; Suggestion)
                <br>
                <span id="ContentPlaceHolder1_lblStatus"></span>
            </td>
        </tr>
        <tr style="border-top: 2px solid #000">
            <td colspan="6" class="auto-style12">&nbsp;&nbsp;&nbsp;&nbsp; เรื่อง (Subject) :
