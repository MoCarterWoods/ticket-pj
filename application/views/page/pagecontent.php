...
<head>
	...
	<!-- Vendors CSS -->
	<!-- <link rel="stylesheet" href="<?php echo base_url() ?>/assets/vendor/css/docs.css" /> -->
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/vendor/css/dropzone.css" />
...
<style>
	...
	<script src="<?php echo base_url() ?>/assets/vendor/libs/cleavejs/autosize.js"></script>
