                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        <td class="text-center">
                          <button class="btnStatus btn badge bg-label-${data[i].spg_status_flg == 1 ? 'success' : 'secondary'} me-1" id="flgStatus" data-sa-id="${data[i].spg_id}" value="${data[i].spg_status_flg}">
                            ${data[i].spg_status_flg == 1 ? 'Enable' : 'Disable'}
                          </button>
                        </td>
                        <td class="text-center">

                        <button class="btn btn-label-danger tblEditBtn btn btn-icon" data-repeater-delete="" data-bs-toggle="modal" data-bs-target="#mdlEdit" id="btnEdit" data-id="${data[i].spg_id}">
